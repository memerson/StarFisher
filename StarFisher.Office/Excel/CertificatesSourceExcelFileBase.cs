...
namespace StarFisher.Office.Excel
{
    ...
    {
        protected CertificatesSourceExcelFileBase(Year year, Quarter quarter, IEnumerable<AwardWinnerBase> awardWinners)
        ...
        private static void BuildWorksheet(ComObjectManager com, Year year, Quarter quarter, IEnumerable<AwardWinnerBase> awardWinners, Worksheet worksheet)
        {
