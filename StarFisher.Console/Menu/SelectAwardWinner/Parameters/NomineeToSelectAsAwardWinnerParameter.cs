...
namespace StarFisher.Console.Menu.SelectAwardWinner.Parameters
{
    public class NomineeToSelectAsAwardWinnerParameter : NomineeParameterBase
    {
        ...
        public NomineeToSelectAsAwardWinnerParameter(AwardType awardType, IReadOnlyCollection<Person> nominees) : base(nominees)
        {
        ...
        {
            WriteCallToAction($@"Enter the number of the nominee you want to select as a {_awardType.PrettyName} winner, or enter 'stop' to stop selecting a {_awardType.PrettyName} winner.");
        }
    }
}