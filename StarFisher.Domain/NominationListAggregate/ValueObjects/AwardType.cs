...
namespace StarFisher.Domain.NominationListAggregate.ValueObjects
{
    ...
    {
        public static readonly AwardType StarValues = new AwardType(@"Employee - Star Values Award Nominee", @"StarValues", @"Star Values Award", AwardAmount.StarValues, AwardCategory.QuarterlyAwards);
        public static readonly AwardType RisingStar = new AwardType(@"Intern - Rising Star Award Nominee", @"RisingStar", @"Rising Star Award", AwardAmount.RisingStar, AwardCategory.QuarterlyAwards);
        public static readonly AwardType SuperStar = new AwardType(@"Employee - Super Star Award Nominee", @"SuperStar", @"Super Star Award", AwardAmount.SuperStar, AwardCategory.SuperStarAwards);

        public static readonly AwardType Invalid =
            new AwardType(@"INVALID", @"INVALID", @"INVALID", AwardAmount.Invalid, AwardCategory.Invalid);

        private AwardType(string value, string fileNameIdentifier, string prettyName, AwardAmount awardAmount, AwardCategory awardCategory)
        {
            Value = value;
